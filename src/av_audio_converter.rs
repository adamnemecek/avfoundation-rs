...
#[repr(u64)]
pub enum AVAudioConverterPrimeMethod {
...
#[repr(u64)]
pub enum AVAudioConverterOutputStatus {
...
pub enum AVAudioConverterFFI {}

foreign_obj_type! {
    type CType = AVAudioConverterFFI;
    pub struct AVAudioConverter;
    pub struct AVAudioConverterRef;
}
